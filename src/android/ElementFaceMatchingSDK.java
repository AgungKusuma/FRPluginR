...
public class ElementFaceMatchingSDK extends CordovaPlugin {
	...
	public static final int MATCHING_REQ_CODE = 12802;
	public static final int ENROLL_REQ_CODE = 12803;
	...
	private boolean doMatching(JSONArray args) throws JSONException {
	    String id = args.getString(0);
        handleCreateActionForMatching(id);
        return true;
	}

	private boolean doEnroll(JSONArray args) throws JSONException {
        String userId = args.getString(0);
        String name = args.getString(1);
        handleCreateActionForEnroll(userId, name);
	    return true;
	}
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
    	Log.i("ElementFaceMatchingSDK", action);
	...
	private void handleCreateActionForEnroll(String userId, String name) {
        ...
        intent.putExtra("ELEMENT_NAME", name);
	...
	private void handleCreateActionForMatching(String userId) {
		Activity activity = cordova.getActivity();
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		if (requestCode == MATCHING_REQ_CODE || requestCode == ENROLL_REQ_CODE) {
